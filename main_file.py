...
LETTERS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ' ##inclusive of vowels
VOWELS  = 'AEIOU'
LETTERS_WITHOUT_VOWELS = 'BCDFGHJKLMNPQRSTVWXYZ'
VOWEL_COST  = 250


#  WOFPlayer class definition 
class WOFPlayer:
...
class WOFComputerPlayer(WOFPlayer):
    SORTED_FREQUENCIES = 'ZQXJKVBPYGFWMUCLDRHSNIOATE' ## Least frequent to most frequent
